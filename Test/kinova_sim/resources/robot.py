...
class Robot:
    def __init__(self, client):
        ...
        self.robot = self.client.loadURDF(fileName=f_name,
                                          basePosition=[0, 0, 0],
                                          useFixedBase=1,
                                          flags=r.URDF_ENABLE_CACHED_GRAPHICS_SHAPES)
    ...
    def apply_action(self, action):
        ...
        # self.client.setJointMotorControl2(self.robot, 2, controlMode=r.POSITION_CONTROL,
        #                                   targetPosition=t2, force=39, maxVelocity=1.39)
    ...
    def get_observation(self):
        ...
        observation = ls[4] + js_angle + angle_sin + angle_cos + js_vel
